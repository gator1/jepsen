...
if [ ! -f ./secret/node.env ]; then
    ...
    echo '# generated by jepsen/ceph-docker/up.sh, parsed by jepsen/ceph-docker/control/bashrc' > ./secret/control.env
...
(
    ...
    (cd ..; tar --exclude=./ceph --exclude=./ceph-docker --exclude=./docker --exclude=./docker-compose -cf - .)  | tar Cxf ./control/jepsen -
)
...
INFO "Please run \`docker exec -it jepsen-ceph-control bash\` in another terminal to proceed"
docker-compose up
